...
int main() {
  ...
  for (i = 0; i < 10001; i++) {
    int *data = (int *) testmalloc(2 << (rand() % 25));
    int *data1 = (int *) testmalloc(2 << (rand() % 25));
    int *data2 = (int *) testmalloc(2 << (rand() % 25));
    int *data3 = (int *) testmalloc(2 << (rand() % 25));
    int *data4 = (int *) testmalloc(2 << (rand() % 25));
    int *data5 = (int *) testmalloc(2 << (rand() % 25));
    int *data6 = (int *) testmalloc(2 << (rand() % 25));
    int *data7 = (int *) testmalloc(2 << (rand() % 25));
